...
export class CalendarComponent implements OnInit {
  ...
  params: { [k: string]: any } = {};
  selected: any;
  constructor(private modal: NgbModal, private nutritionist: NutritionistService,
    // tslint:disable-next-line: align
    private patient: PatientService, private router: ActivatedRoute) { }
  ngOnInit() {
    this.router.queryParams.subscribe(params => {
      this.username = params.username;
      this.newEvent.nutritionist = this.username;
      this.params.patient = this.username;
  ...
  retriveConsultations() {
    this.patient.getConsultations(this.params).then(data => {
      data.forEach(e => {
